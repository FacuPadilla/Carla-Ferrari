const CardProject = ({
  ...
  return (
    <article
      className="mx-auto w-[370px] md:w-[400px] shadow-xl h-96  bg-cover bg-no-repeat bg-center   transform duration-500 hover:-translate-y-2 cursor-pointer group my-10 lg:my-6 "
      style={{
    ...
    >
      {" "}
      <a href={link}>
        <div className="bg-black bg-opacity-20 min-h-150 h-full px-10  pt-52 hover:bg-opacity-75 transform duration-300 ">
