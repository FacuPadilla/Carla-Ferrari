const CardProject = ({
  ...
  return (
    <article className="mx-auto w-[370px] md:w-[400px] shadow-xl h-[430px] transform duration-500 hover:-translate-y-2 cursor-pointer group my-10 lg:my-6">
      <a href={link}>
        <div className="relative h-full">
          <img
            src={img}
            alt={title}
            className="w-full h-full object-fit" // Asegura que la imagen no se recorte ni distorsione
          />
